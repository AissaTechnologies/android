package com.aissatech.android.sunshine.app.data;

/**
 * Created by aissa_000 on 28/03/2015.
 */
/*
...
public class WeatherContract {
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // location settings string that will be send to openweathermap as query string
        public static final String COLUMN_LOCATION_SETTING = "location_setting";
        // location string of city name provided from the API
        public static final String COLUMN_CITY_NAME = "city_name";
        // latitude and longitude returned from openweathermap
